...
from cntk.internal import sanitize_input, sanitize_shape, sanitize_axis, sanitize_axis_list, sanitize_dynamic_axes, sanitize_pooling_args, sanitize_convolution_args
